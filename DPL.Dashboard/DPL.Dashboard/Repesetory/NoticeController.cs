                ...
                try
                {
                    ...
                    for (int i = 0; i < Notices.Count; i++)
                    {
                        ...
                        if (intid == 0)
                        {
                            ...
                            strSQL = "INSERT INTO HRS_NOTICE(";
                            strSQL = strSQL + "NOTICE_ID, TITLE, ANNOUNCEMENT, START_DATE, END_DATE,NOTICE_IMG , STATUS, CREATED_BY";
                        ...
                        {
                            strSQL = "INSERT INTO HRS_MARKET_ACCESS (";
                        ...
                        else if (intid == 2)
                        {
                            ...
                            strSQL = strSQL + "NOTICE_ID,NATIONAL_HEAD, TEAM,ZONE,DIVISION,AREA,MARKET,ROUTE,USER_NAME,USER_ROLE";
