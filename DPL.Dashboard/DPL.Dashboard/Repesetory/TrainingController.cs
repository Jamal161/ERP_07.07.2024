                ...
                try
                {
                    ...
                    for (int i = 0; i < Train.Count; i++)
                    {
                        ...
                        if (intid == 0)
                        {
                            ...
                            strSQL = "INSERT INTO HRS_TRAINING_DASH(";
                            strSQL = strSQL + "NOTICE_ID, TITLE, ANNOUNCEMENT, START_DATE, END_DATE, EDITOR, INSERT_BY";
                        ...
                        {
                            strSQL = "INSERT INTO HRS_MARKET_ACCESS_TRAINING (";
                            strSQL = strSQL + "NOTICE_ID,NATIONAL_HEAD, TEAM,ZONE,DIVISION,AREA,MARKET,ROUTE,EMP_CARD_NO";
                            ...
                            strSQL = strSQL + "'" + Train[i].strEMP_CARD_NO + "'";
                        ...
                        {
                            strSQL = "INSERT INTO HRS_TRANNING_USER (";
