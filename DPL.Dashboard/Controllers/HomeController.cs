        ...
        public string mPostShiftConfig(ShiftCongfig obj)
        {
            ...
            using (SqlConnection gcnMain = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    strSQL = strSQL + " SHIFT_CONFIG_START_TIME,SHIFT_CONFIG_END_TIME, ";
                    strSQL = strSQL + "  OT_STATUS";
                    strSQL = strSQL + ") ";
                    strSQL = strSQL + "VALUES (";
                    strSQL = strSQL + "'" + obj.strEMPLOYEE_SHIFT_NAME + "',";
                    strSQL = strSQL + "'" + obj.strEMPLOYEE_SHIFT_NAME_BANGLA + "',";
                    strSQL = strSQL + "" + obj.dblSHIFT_CONFIG_START_TIME + ",";
                    strSQL = strSQL + "" + obj.dblSHIFT_CONFIG_END_TIME + ",";
                    strSQL = strSQL + "" + obj.intOT_STATUS + "";
                    strSQL = strSQL + ")";
